...
import { MixinLimit, MixinLimits, Daemon } from '@trrxitte/traaittcash-wallet-backend';
...
const Config = new function() {
    ...
    this.mixinLimits = new MixinLimits([
        ...
        new MixinLimit(17000000, 3, 10, 10),

        /* At height of 620000, static mixin of 7 */
        new MixinLimit(43000000, 10),

        /* At height of 800000, static mixin of 3 */
        new MixinLimit(68000000, 15),
    ], 8 /* Default mixin of 3 before block 17,000,000 */);
     ...
     */
    this.defaultDaemon = new Daemon('us-east.trrxitte.com', 14486);
     ...
     *
     */
    this.repoLink = 'https://github.com/TRRXITTE/traaittCASHstorage';

    /**
     * This only controls the name in the settings screen.
     */
    this.appName = 'traaittCASH wallet';

    /**
     * Slogan phrase during wallet CreateScreen
     */
    this.sloganCreateScreen = 'XTCASH empowered.';
     ...
     */
    this.explorerBaseURL = 'https://interface.traaittcash.com/transaction.html?hash=';
     ...
     */
    this.googlePlayLink = 'https://play.google.com/store/apps/details?id=com.traaittcashstorages';
